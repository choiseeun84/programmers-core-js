...
const floatingPointNember = 1.23;

console.log( typeof integer);

const num = new Number(20, 30); //number constructor function
...
const arr = ['a','100','tiger',['a','d'], true, ()=>{}]
...
//console.log(팥붕)  //결과값 : 따끈하고 맛있는 팥 맛 붕어빵입니다..
