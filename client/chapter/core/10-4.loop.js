...
// in문 포함됐는지 포함되지 않았는지 불린값으로 나타내줌
...
console.log( Object.hasOwn(javaScript, 'nikName') );
...
// - 객체 자신의 속성만 순환하려면?
// - 배열 객체 순환에 사용할 경우?
//for...in문은 객체를 순환하는 용도로 사용됨. => 원본 췌손 여지 => hasOwn

for (const key in javaScript){

    // console.log(key);
    // if(Object.protitype.hasOwnProperty.call(javascript,key)){
...
// for ...in을 사용해서 배열을 순환 => 순서를 보장하지 않기 떄문에, 위험하다.
// 객체 순환용 사용해야 한다.
