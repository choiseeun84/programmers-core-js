...
for (let key of 'hello javascript') {
    // console.log(key);
}
...
for(const value of languages){
    ...
    if(name.includes('java') && name.langth < 5 ) continue;
...
const values = Object.values(obj) // 객체의 valuse들을 모아 새로운 배열을 '반환' 하는 유틸 함수
// ['tiger', 30]

const entries = Object.entries(obj) // 객체의 key,values를 모아 한 쌍의 배열로 '변환'하는 유틸 함수
// [[key,value],[key,value]]
