...
// 객체의 value들을을 모아서 배열로 반환하는 객체의 static method는?
// Object.values
...
// 객체의 key와 value를 하나의 쌍으로 묶어서 새로운 배열을 변환하는 객체의 static method는?
// Object.entries
...
// 순서(order)를 바꿀 수 없음. 변수명 내 마음대러러
...
for(const KeyValue of Object.entries(authUser)){
