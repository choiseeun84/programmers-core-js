...
switch (thisTime) {
    case MORNING: console.log('아침 밥 먹기'); break;
    case LUNCH: console.log('배달의 민족 서치'); break;
    case DINNER: console.log('오늘 배운 내용 복습하기'); break;
    case NIGHT: console.log('팀원들과 소통하기기'); break;
    case LATE_NIGHT: 
